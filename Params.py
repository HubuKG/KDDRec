...
def ParseArgs():
	...
	parser.add_argument('--lr', default=5.2e-4, type=float, help='learning rate')
	...
	parser.add_argument('--two_reg_weiht', type=float, default=0.5)
	parser.add_argument('--vae_hidden_dims', type=int, default=64)
